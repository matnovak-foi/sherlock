...
public class JTreeTable
  ...
  /**
   * <p>Component used by TreeTableCellEditor. The only thing this does
   * is to override the <code>reshape</code> method, and to ALWAYS
   * make the x location be <code>offset</code>.</p>
   * 
   * <p>Added override of the <code>setBounds</code> method and changed the call 
   * to use the parent <code>setBounds</code> as <code>reshape</code> has been
   * deprecated as of JDK 1.5 (DRW).</p>
   */
